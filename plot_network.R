...
mygraph<- qgraph(easMat,details=FALSE,shape="square",repulsion=.7, usePCH=TRUE,fade=FALSE,curveScale=TRUE, layout = "spring", node.height=3.5,label.prop=1.1,asize=1)
