...
\begin{figure}
\centering
\includegraphics[width=5in]{Step_2/Paper_01.png}
\caption{All genes}
\label{fig:allgenes}
\end{figure}
...
\iffalse \textit{Refinement Step} \fi
...
\begin{figure}
\includegraphics[width=5in]{Step_8/Network_plot_MATLAB.pdf}
