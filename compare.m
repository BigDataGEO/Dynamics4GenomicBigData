function compare()
  ...
  if(size(inputData,1) > 1)
    ...
    general_comparison_folder = [Dynamics4GenomicBigData_HOME, 'Results/' inputData{1,1} '/Comparison/' output_dir];
...
%  	    one_to_one_comparison_folder = [general_comparison_folder, '/', inputData{i,1}, '/', inputData{i,2}, '_vs_', inputData{j,2}];
	    one_to_one_comparison_folder = [general_comparison_folder, '/', inputData{i,2}, '_vs_', inputData{j,2}];
